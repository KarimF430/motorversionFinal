  ...
  return (
    <div className="p-8 space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        />
        <StatsCard title="Total Models" value={stats?.totalModels || 0} icon={Car} />
        <StatsCard title="Total Variants" value={stats?.totalVariants || 0} icon={Gauge} />
        <StatsCard title="Active Users" value="500k/day" icon={Users} />
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-green-700 dark:text-green-300 mt-1">
              MotorOctane backend is running successfully on port 5000. All API endpoints are
